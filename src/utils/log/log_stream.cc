...
#include "rdbms/utils/log_stream.hpp"

#include <inttypes.h>

using namespace rdbms;
using namespace rdbms::detail;
...
constexpr const char kDigits[] = "9876543210123456789";
constexpr const char* kZero = kDigits + 9;
static_assert(sizeof(kDigits) == 20, "Wrong number of digits");

constexpr const char kDigitsHex[] = "0123456789ABCDEF";
